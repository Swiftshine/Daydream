        ...
        for root, dirs, files in os.walk("src"):
            for file in files:
                if file.endswith(".cpp"):
                    # ignore loader files
                    if file == "loader.cpp" or file == "suk_loader.cpp":
                        continue
...
if __name__ == '__main__':
    ...
    kamek_command = f"{KAMEK} {cpp_object_files} {asm_object_files} -externals=symbols/{region}.txt -output-kamek=build/SUK_{region}.bin"
